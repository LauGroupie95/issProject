		...
		return { //this:ActionBasciFsm
				...
				state("waitCmd") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t00",targetState="reachTable",cond=whenDispatch("startClear"))
				}	 
				...
				state("inTable") { //this:State
					action { //it:State
						...
						forward("moveFoodOnRobot", "moveFoodOnRobot(table)" ,"kb" ) 
						delay(1000) 
				...
				state("endClear") { //this:State
					action { //it:State
						...
						forward("endClear", "endClear" ,"master3" ) 
					}
				}	 
			}
		}
