...
import alice.tuprolog.*
    ...
    object clientWenvObjTcp {
        ...
        private var port     = 8999 //porta frontend
        private val sep      = ";"
        ...
        fun initClientConn(actor:ActorBasicFsm, filter : ActorBasic?,
						   hostName: String = "localhost", portStr: String = "8080" ) {
        ...
        fun sendMsg(v: String) {
			...
			when(ts){
				"homeReached" -> outS = "{'type': 'homeReached',  'arg': 'homeReached' }"
    			"endPrepare"  -> outS = "{'type': 'endPrepare', 'arg': 'endPrepare' }"
				"foodAdded"   -> outS = "{'type': 'foodAdded', 'arg': 'foodAdded' }"
 				"warning"     -> outS = "{'type': 'warning', 'arg': 'warning' }"
				"endClear"    -> outS = "{'type': 'endClear', 'arg': 'endClear' }"
 			}
