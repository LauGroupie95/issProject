...
@rem ##########################################################################
@rem
@rem  itUniboParty startup script for Windows
@rem
@rem ##########################################################################
...
@rem Add default JVM options here. You can also use JAVA_OPTS and IT_UNIBO_PARTY_OPTS to pass JVM options to this script.
...
@rem Execute itUniboParty
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %IT_UNIBO_PARTY_OPTS%  -classpath "%CLASSPATH%" it.unibo.ctxParty.MainCtxPartyKt %CMD_LINE_ARGS%
...
:fail
rem Set variable IT_UNIBO_PARTY_EXIT_CONSOLE if you need the _script_ return code instead of
rem the _cmd.exe /c_ return code!
if  not "" == "%IT_UNIBO_PARTY_EXIT_CONSOLE%" exit 1
exit /b 1
