		...
		return { //this:ActionBasciFsm
				...
				state("waitCmd") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t00",targetState="doPrepare",cond=whenDispatch("startPrepare"))
				}	 
				...
				state("inFridge") { //this:State
					action { //it:State
						...
						forward("moveSpecificFoodOnRobot", "moveSpecificFoodOnRobot($FoodCodeList)" ,"kb" ) 
						delay(1000) 
						println("Obiettivo TABLE")
						forward("reachTable", "reachTable(prepare)" ,"navi" ) 
					}
				...
				state("endPrepare") { //this:State
					action { //it:State
						...
						println("")
						forward("expose", "expose" ,"kb" ) 
						forward("endPrepare", "endPrepare" ,"master3" ) 
					}
				}	 
			}
		}
