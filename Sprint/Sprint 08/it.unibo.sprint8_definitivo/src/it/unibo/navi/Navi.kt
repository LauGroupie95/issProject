		...
		return { //this:ActionBasciFsm
				...
				state("planPathToAppliance") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t16",targetState="reachRequestedGoal",cond=whenDispatch("startGoal"))
				}	 
				state("returnHome") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t27",targetState="reachRequestedGoal",cond=whenDispatch("startGoal"))
				}	 
				state("planPathToTable") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t38",targetState="reachRequestedGoal",cond=whenDispatch("startGoal"))
				}	 
				...
				state("doForwardMove") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t49",targetState="handleStepOk",cond=whenDispatch("stepOk"))
					transition(edgeName="t410",targetState="hadleStepFail",cond=whenDispatch("stepFail"))
				}	 
