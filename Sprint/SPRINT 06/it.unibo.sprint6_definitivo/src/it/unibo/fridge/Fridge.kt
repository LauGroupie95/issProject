		...
		return { //this:ActionBasciFsm
				...
				state("wait") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t00",targetState="consultEvent",cond=whenEvent("consult"))
					transition(edgeName="t01",targetState="takeFromFridge",cond=whenDispatch("moveSpecificFoodOnRobot"))
					transition(edgeName="t02",targetState="putInFridge",cond=whenDispatch("moveFoodToFridge"))
					transition(edgeName="t03",targetState="coapAnswer",cond=whenDispatch("handleAnswerReply"))
				}	 
				...
				state("consultEvent") { //this:State
					action { //it:State
						println("")
						println("State consultEvent")
						if(KbConsulted == false){ solve("exposeFridge(F)","") //set resVar	
						if(currentSolution.isSuccess()) { var ExposeFridge = getCurSol("F").toString() 
						println("Cibo in fridge: ${ExposeFridge}")
						forward("consultReplyFridge", "consultReplyFridge($ExposeFridge)" ,"master6" ) 
						KbConsulted = true
						 }
						 }
						else
