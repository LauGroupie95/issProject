...
object moveUtils{
	...
	fun doPlannedMove(actor : ActorBasic, move: String){
		...
		utils.writeLog("$oldRobotPosition | $move | (${plannerUtil.getPosX()}, ${plannerUtil.getPosY()}, ${getDirection(actor)})")
	}
	...
	suspend fun backToCompensate(actor : ActorBasic, stepTime : Int, pauseTime : Int = PauseTime){
		...
		utils.writeLog("$oldRobotPosition | s | (${plannerUtil.getPosX()}, ${plannerUtil.getPosY()}, ${getDirection(actor)})")
		...
		utils.writeLog("$oldRobotPosition | h | (${plannerUtil.getPosX()}, ${plannerUtil.getPosY()}, ${getDirection(actor)})")
   	}
