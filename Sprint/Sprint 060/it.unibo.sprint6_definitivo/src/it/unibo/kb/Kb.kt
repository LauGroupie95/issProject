		...
		return { //this:ActionBasciFsm
				...
				state("doExpose") { //this:State
					action { //it:State
						...
						if(currentSolution.isSuccess()) {  var foodOnTable = utils.replaceUglyString( getCurSol("FT").toString() )
						...
						if(KbConsulted == false){ forward("consultReplyKb", "consultReplyKb($ToSend)" ,"master6" ) 
						KbConsulted = true
						 }
					}
					 transition( edgeName="goto",targetState="waitCmd", cond=doswitch() )
