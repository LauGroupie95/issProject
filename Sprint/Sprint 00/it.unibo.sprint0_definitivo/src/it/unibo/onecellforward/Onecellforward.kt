	...
	override fun getBody() : (ActorBasicFsm.() -> Unit){
		...
		return { //this:ActionBasciFsm
				state("s0") { //this:State
					...
					transition(edgeName="t012",targetState="changeColumn",cond=whenDispatch("changeCol"))
				}	 
				state("changeColumn") { //this:State
					action { //it:State
				...
				state("doMoveForward") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t013",targetState="endDoMoveForward",cond=whenTimeout("local_tout_onecellforward_doMoveForward"))   
					transition(edgeName="t014",targetState="s0",cond=whenDispatch("stopAppl"))
