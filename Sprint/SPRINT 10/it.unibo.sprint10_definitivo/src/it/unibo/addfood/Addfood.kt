		...
		return { //this:ActionBasciFsm
				...
				state("waitCmd") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t06",targetState="requestForCode",cond=whenDispatch("addFood"))
					transition(edgeName="t07",targetState="waitCmd",cond=whenDispatch("answerFromFridgeCoap"))
				}	 
				state("requestForCode") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t18",targetState="checkAnswer",cond=whenDispatch("answerFromFridgeCoap"))
				}	 
				...
				state("reachFridge") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t49",targetState="inFridge",cond=whenDispatch("fridgeReached"))
				}	 
				state("inFridge") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t410",targetState="inTable",cond=whenDispatch("tableReached"))
				}	 
				state("inTable") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t311",targetState="endAddFood",cond=whenDispatch("homeReached"))
				}	 
				state("endAddFood") { //this:State
					action { //it:State
						...
						delay(500) 
						forward("foodAdded", "foodAdded(addfood)" ,"rbr" ) 
					}
					 transition( edgeName="goto",targetState="waitCmd", cond=doswitch() )
				}	 
				state("handleWarning") { //this:State
					action { //it:State
						delay(500) 
						forward("warning", "warning($FoodCode)" ,"rbr" ) 
					}
					 transition( edgeName="goto",targetState="waitCmd", cond=doswitch() )
				}	 
			}
