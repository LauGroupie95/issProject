	...
	override fun getBody() : (ActorBasicFsm.() -> Unit){
		...
		return { //this:ActionBasciFsm
				...
				state("exploreEdge") { //this:State
					action { //it:State
						if(EndScanningTable == true){ forward("endScanningTable", "endScanningTable" ,"findtable" ) 
						 }
						else
						 { StepAroundTable++
				...
				state("goHome") { //this:State
					action { //it:State
						...
						if(currentSolution.isSuccess()) { println("Invio al navigator la posizione corrente del robot: ${getCurSol("X")} ${getCurSol("Y")} ${getCurSol("D")}")
						emit("robotPosition", "robotPosition(${getCurSol("X")},${getCurSol("Y")},${getCurSol("D")})" ) 
						delay(1000) 
						 }
						forward("endScanningTable", "endScanningTable" ,"master2" ) 
					}
